...
//         "INSERT INTO employees (name, email, password, role, position, team, join_date, birthday) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
//         [
//           adminName,
//           adminEmail,
//           hashedPassword,
...
//           "Admin",
//           "Management",
//           new Date(), // Set join_date to current date
//           null,       // Set birthday to null
//         ]
//       ); // 3. Log success
//       console.log(
...
//   const { name, email, password, position, teams, join_date, birthday } = req.body;
...
//     // Add join_date and birthday to the update query if they exist
//     if (join_date) {
...
//     try {
//       // Check if the employee to be deleted is an admin
...
//       if (
//         employee.length > 0 &&
//         String(employee[0].role).toLowerCase() === "admin"
//       ) {
//         return res
//           .status(403)
...
//     const TOTAL_ANNUAL_LEAVE = 12; // Base AL quota
